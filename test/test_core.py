...
def test_pubkey():
    ...
    assert pubkey.molecule_pack().hex() == '0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798'
    assert ckb.core.PubKey.molecule_read(pubkey.molecule_pack()) == pubkey


def test_pubkey_hash():
    prikey = ckb.core.PriKey(1)
    pubkey = prikey.pubkey()
    assert ckb.core.hash(pubkey.molecule_pack())[:20].hex() == '75178f34549c5fe9cd1a0c57aebd01e7ddf9249e'
...
def test_addr():
    ...
    assert ckb.core.Script.molecule_read(script.molecule_pack()) == script
